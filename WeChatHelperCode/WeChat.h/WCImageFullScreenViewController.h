...
@interface WCImageFullScreenViewController : MMUIViewController <UIScrollViewDelegate, scrollViewDelegate, WCImageFullScreenViewContainerDelegate, IVOIPUILogicMgrExt, MMExposeViewControllerDelegate, ShareDataToOpenSDKControllerDelegate, FavAddItemHelperDelegate, ForwardMessageLogicDelegate>
{
